...
<head>
    ...
    if(isset($_SESSION["username"])){
        ...
        if(isset($_GET["pid"])){
            $result = selectMedicalProfile($_GET["pid"]);
            if ($result->num_rows > 0){
                $row=$result->fetch_assoc();
            }else{
                die("Profile Not Found<br><a href='medical_list.php'>Go To Medical List</a>");
            }
        }
    }else{
    ...
    ?>
    <title><?php echo $row["m_s_name"]?> Profile</title>
                    ...
                    <div class="container" style="margin-top: 30px;">
                        <div class="profile-head">
                            <div class="col-md- col-sm-4 col-xs-12">
                                ...
                                <h6><?php echo $row["m_s_name"]?></h6>
                            </div><!--col-md-4 col-sm-4 col-xs-12 close-->


                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <h5><?php echo $row["m_s_name"]?></h5>
                                <p>Medical Store</p>
                                <ul>
                                    <li><span class="glyphicon glyphicon-home"></span><?php echo $row["m_s_address"]?></li>
                                    <li><span class="glyphicon glyphicon-phone"></span> <a href="#" title="call"><?php echo $row["m_s_phone_no"]?></a></li>
                                    <li><span class="glyphicon glyphicon-envelope"></span><a href="#" title="mail"><?php echo $row["m_s_email"]?></a></li>
                                </ul>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="table-responsive responsiv-table">
                                                <table class="table bio-table">
                                                    ...
                                                    <tr>
                                                        <td>Name</td>
                                                        <td>: <?php echo $row["m_s_name"]?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Address</td>
                                                        <td>: <?php echo $row["m_s_address"]?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>City</td>
                                                        <td>: <?php echo $row["m_s_city"]?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Pincode</td>
                                                        <td>: <?php echo $row["m_s_pincode"]?></td>
                                                    </tr>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="table-responsive responsiv-table">
                                                <table class="table bio-table">
                                                    ...
                                                    <tr>
                                                        <td>Email Id</td>
                                                        <td>: <?php echo $row["m_s_email"]?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Mobile</td>
                                                        <td>: <?php echo $row["m_s_phone_no"]?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Start Time</td>
                                                        <td>: <?php echo $row["m_s_starttime"]?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>End Time</td>
                                                        <td>: <?php echo $row["m_s_endtime"]?></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div><!--table-responsive close-->
