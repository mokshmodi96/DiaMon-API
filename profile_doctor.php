...
<head>
    ...
    if(isset($_SESSION["username"])){
        ...
        if(isset($_GET["pid"])){
            $result = selectDoctorProfile($_GET["pid"]);
            if ($result->num_rows > 0){
                $row=$result->fetch_assoc();
            }else{
                die("Profile Not Found<br><a href='doctor_list.php'>Go To Doctor List</a>");
            }
        }
    }else{
    ...
    ?>
    <title><?php echo $row["d_firstname"]." ".$row["d_lastname"]?> Profile</title>
    ...
    <style type="text/css">
        ...
        .profile-head { width:100%;background-color: #6164C1;float: left;padding: 15px 5px;}
        ...
        .hve-pro {    background-color:#6164C1;padding: 5px; width:100%; height:auto;float:left;}
        ...
        h2.register { padding:10px 25px; text-transform:capitalize;font-size: 25px;color: #6164C1;}
        .fom-main { overflow:hidden;}

        legend {font-family: 'Bitter', serif;color:#6164C1;border-bottom:0px solid;}
        .main_form {background-color: #6164C1;}
        ...
        .submit-button {color: #fff;background-color:#6164C1;width:190px;border: 0px solid;border-radius: 0px; transition:all ease 0.3s;margin: 5px;
            float:left;}
        .submit-button:hover, .submit-button:focus {color: #fff;background-color:rgb(0, 4, 51);}
        .hint_icon {color:#6164C1;}
        .form-control:focus {border-color: #6164C1;}
        ...
        .uplod-file:hover, .uplod-file:focus {color: #fff;background-color:#6164C1;}
        ...
        .nav-menu li.active a {background-color: #6164C1 !important;}
        ...
        @media all and (max-width:768px){
            ...
            a.menu { display:block !important;margin: 9px 2px;float: right;color: #6164C1; border:0px solid; background:none; font-size:30px;width:27px;position: relative;
                cursor:pointer;}
                    ...
                    <div class="container" style="margin-top: 30px;">
                        <div class="profile-head">
                            <div class="col-md- col-sm-4 col-xs-12">
                                ...
                                <h6><?php echo "Dr.".$row["d_firstname"]." ".$row["d_lastname"]?></h6>
                            </div><!--col-md-4 col-sm-4 col-xs-12 close-->


                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <h5><?php echo "Dr.".$row["d_firstname"]." ".$row["d_lastname"]?></h5>
                                <p>Medical Store</p>
                                <ul>
                                    <li><span class="glyphicon glyphicon-home"></span><?php echo $row["d_address"]?></li>
                                    <li><span class="glyphicon glyphicon-phone"></span> <a href="#" title="call"><?php echo $row["d_contact_info"]?></a></li>
                                    <li><span class="glyphicon glyphicon-envelope"></span><a href="#" title="mail"><?php echo $row["d_email"]?></a></li>
                                </ul>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="table-responsive responsiv-table">
                                                <table class="table bio-table">
                                                    ...
                                                    <tr>
                                                        <td>Name</td>
                                                        <td>: <?php echo "Dr.".$row["d_firstname"]." ".$row["d_lastname"]?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Address</td>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="table-responsive responsiv-table">
                                                <table class="table bio-table">
                                                    ...
                                                    <tr>
                                                        <td>Mobile</td>
                                                        <td>: <?php echo $row["d_contact_info"]?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Reg No.</td>
                                                        <td>: <?php echo $row["d_reg"]?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Degree</td>
                            ...
                            <div class="tab-pane fade" id="change">
                                <div class="container fom-main">
                                    ...
                                    <div class="row">
                                        ...
                                        <form class="form-horizontal main_form text-left" onsubmit="return ajaxfunction();" method="post"
                                              id="contact_form">
                                            <fieldset>
