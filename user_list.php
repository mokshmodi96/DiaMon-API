                        ...
                        if ($result->num_rows > 0) {
                            while ($row=$result->fetch_assoc()){
                                if($row['u_status']==0) {
                                    ...
                                    echo "<tr> <th scope='row'>$i</th><td>" . $row["u_fname"] . "</td> <td>" . $row["u_lname"] . "</td> <td>" . $row["u_email"] . "</td><td>" . $row["u_phone_no"] . "</td><td><b>Verified</b></td><td><a href='profile_user.php?pid=".$row["u_id"]."'>View Profile</td><td><a href='delete_user.php?id=" . $row['u_id'] . "'>Delete</a></td></tr>";
                                }
                                $i++;
                            }
                        }else{
