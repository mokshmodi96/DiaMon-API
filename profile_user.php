...
<head>
    ...
    if (isset($_SESSION["username"])) {
        ...
        if (isset($_GET["pid"])) {
            $result = selectUserProfile($_GET["pid"]);
            if ($result->num_rows > 0) {
                $row = $result->fetch_assoc();
            } else {
                die("Profile Not Found<br><a href='user_list.php'>Go To User List</a>");
            }
        }
    } else {
    ...
    ?>
    <title><?php echo $row["u_fname"] . " " . $row["u_lname"] ?> Profile</title>
                    ...
                    <div class="container" style="margin-top: 30px;">
                        <div class="profile-head">
                            <div class="col-md- col-sm-4 col-xs-12">
                                ...
                                <h6><?php echo $row["u_fname"] . " " . $row["u_lname"] ?></h6>
                            </div><!--col-md-4 col-sm-4 col-xs-12 close-->


                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <h5><?php echo $row["u_fname"] . " " . $row["u_lname"] ?></h5>
                                <p>User</p>
                                <ul>
                                    <li><span class="glyphicon glyphicon-phone"></span> <a href="#"
                                                                                           title="call"><?php echo $row["u_phone_no"] ?></a>
                                    </li>
                                    <li><span class="glyphicon glyphicon-envelope"></span><a href="#"
                                                                                             title="mail"><?php echo $row["u_email"] ?></a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="table-responsive responsiv-table">
                                                <table class="table bio-table">
                                                    ...
                                                    <tr>
                                                        <td>Name</td>
                                                        <td>
                                                            : <?php echo $row["u_fname"] . " " . $row["u_lname"] ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Gender</td>
                                                    ...
                                                    <div class="col-md-12 inputGroupContainer">
                                                        <div class="input-group">
                                                            <input name="first_name" placeholder="First Name"
                                                                   ...
                                                                   value="<?php echo $row["u_fname"] ?>" id="fname">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12 inputGroupContainer">
                                                        <div class="input-group">
                                                            <input name="last_name" placeholder="Last Name"
                                                                   class="form-control" type="text"
                                                                   value="<?php echo $row["u_fname"] ?>" id="lname">
                                                        </div>
                                                    </div>
                                                </div>
